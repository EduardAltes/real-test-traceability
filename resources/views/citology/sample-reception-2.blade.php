    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 bg-white p-6 rounded-lg shadow">
            <form method="POST" action="{{ route('sample-reception.store') }}">
                ...
                <!-- Tipus (1) -->
                <div class="mb-4">
                    <label for="tipus1" class="block text-gray-700">Tipus (1)</label>
                    <select id="tipus1" name="tipus1" class="w-full p-2 border rounded" required>
                        <option value="">Selecciona...</option>
                ...
                <!-- Tipus (2) -->
                <div class="mb-4">
                    <label for="tipus2" class="block text-gray-700">Tipus (2)</label>
                    <select id="tipus2" name="tipus2" class="w-full p-2 border rounded" required>
                        <option value="">Selecciona...</option>
                        <option value="tipus_x">Tipus X</option>
                        <option value="tipus_y">Tipus Y</option>
                    </select>
                </div>
